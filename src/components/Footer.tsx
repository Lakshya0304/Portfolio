      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8 border-b border-gray-800">
          <div className="col-span-1 md:col-span-2">
            ...
            >
              Lakshya<span className="text-portfolio-purple">K.</span>
            </motion.h2>
            <motion.p
            ...
            >
              Full-Stack Developer specializing in creating performant, secure,
              and accessible web applications with modern technologies.
            </motion.p>
            <motion.div
          ...
          >
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <svg
                  className="w-5 h-5 text-portfolio-purple mr-3 mt-0.5"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
        ...
        >
          <p>© {year} Lakshya Khandelwal. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
